...
public class MessagesSentController implements Initializable {
...
@FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        allMessages = service.getAllBySender(loggedInUser.getId()); // Remplacez 2 par l'ID de l'utilisateur
    ...
    public void exportdata(ActionEvent event) {
        try {
            ...
            fileChooser.setInitialFileName("messages_sent_data.csv");
